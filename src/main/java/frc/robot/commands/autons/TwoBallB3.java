...
public class TwoBallB3 extends SequentialCommandGroup {

    public TwoBallB3 (SwerveDrivetrain drivetrain, IntakeSubsystem intake, IndexerSubsystem indexer, ShooterSubsystem shooter, PathPlannerTrajectory trajectory) {
        super(

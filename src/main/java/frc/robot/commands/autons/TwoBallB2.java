...
public class TwoBallB2 extends SequentialCommandGroup {

    public TwoBallB2 (SwerveDrivetrain drivetrain, IntakeSubsystem intake, IndexerSubsystem indexer, ShooterSubsystem shooter, PathPlannerTrajectory trajectory) {
        super(

...
public class TwoBallR3 extends SequentialCommandGroup {

    public TwoBallR3 (SwerveDrivetrain drivetrain, IntakeSubsystem intake, IndexerSubsystem indexer, ShooterSubsystem shooter, PathPlannerTrajectory trajectory) {
        super(

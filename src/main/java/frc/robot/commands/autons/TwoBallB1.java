...
public class TwoBallB1 extends SequentialCommandGroup {

    public TwoBallB1 (SwerveDrivetrain drivetrain, IntakeSubsystem intake, IndexerSubsystem indexer, ShooterSubsystem shooter, PathPlannerTrajectory trajectory) {
        super(

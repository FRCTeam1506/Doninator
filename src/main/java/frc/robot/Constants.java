...
public final class Constants {
    public static final class SwerveDrivetrain {
        ...
        public static final class Mod0 {
            ...
            public static final double ANGLE_OFFSET = 297.949; // 297.598
        ...
        public static final class Mod1 {
            ...
            public static final double ANGLE_OFFSET = 70.928; // 71.104
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CAN_CODER_ID, ANGLE_OFFSET);
        }
        ...
        public static final class Mod2 {
            ...
            public static final double ANGLE_OFFSET = 346.553; // 346.729
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CAN_CODER_ID, ANGLE_OFFSET);
        }
        ...
        public static final class Mod3 {
            ...
            public static final double ANGLE_OFFSET = 91.934; // 93.428
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CAN_CODER_ID, ANGLE_OFFSET);
        }
    }
